...
#let cv(
  ...
  let ff = (
    (
      header-name: "New Computer Modern",
      header-headline: "New Computer Modern",
      header-location: "New Computer Modern",
      header-tags: "New Computer Modern",
      section-title: "New Computer Modern",
      body: "New Computer Modern",
      entry-text: "New Computer Modern",
      entry-highlight: "New Computer Modern",
      summary: "New Computer Modern",
    )
      + font-family
  )
